...
public class RestLaundryItemModel {
	...
	public RestLaundryItemModel(Object lItemID, Object lItemName, Object lItemCategoryName, Object itemGroupType,
			Object purchaseSubGroup, Object salesSubGroup, Object lItemDesc, Object lItemimage, Object lItemStatus,
			Object createdBy, Object createdDate,Object lItemCategoryID) {
		super();
		this.lItemID = (String) lItemID;
		this.lItemName = (String) lItemName;
		this.lItemCategoryName = (String) lItemCategoryName;
		this.itemGroupType = (String) itemGroupType;
		this.purchaseSubGroup = (String) purchaseSubGroup;
		this.salesSubGroup = (String) salesSubGroup;
		this.lItemDesc = (String) lItemDesc;
		this.lItemimage = (String) lItemimage;
		this.lItemStatus = (String) lItemStatus;
		this.createdBy = (String) createdBy;
		this.createdDate = (String) createdDate;
		this.lItemCategoryID = (String) lItemCategoryID;
	}

	public RestLaundryItemModel() {
