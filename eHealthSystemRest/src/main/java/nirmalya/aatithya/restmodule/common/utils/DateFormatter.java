...
public class DateFormatter {
	...
	public static String returnStringDateNew(String date) {
	...
	public static String getStringTimeMS(String date) {
	...
	public static Object returnStringDate(Object date) {
		...
		try {
			System.out.println("in Func===" + date);
	...
	public static String getStringDateMMM(String date) {
