...
public class AmbulanceProfileMdel {
...
private List<AmbulanceProfileDocumentModel> documentList;
//
private String profileImg;
private String docExperience;

public AmbulanceProfileMdel() {
	super();
...
public List<AmbulanceProfileDocumentModel> getDocumentList() {
	return documentList;
}

public void setDocumentList(List<AmbulanceProfileDocumentModel> documentList) {
