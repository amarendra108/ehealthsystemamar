...
private List<DoctorProfileDocumentModel> documentList;
//
...
public List<DoctorProfileDocumentModel> getDocumentList() {
	return documentList;
}

public void setDocumentList(List<DoctorProfileDocumentModel> documentList) {
