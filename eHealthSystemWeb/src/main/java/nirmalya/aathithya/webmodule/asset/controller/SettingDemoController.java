...
public class SettingDemoController {
	...
	@GetMapping("job-sides")
	public String jobSides(Model model, HttpSession session) {

		logger.info("Method : viewProduct starts");
		model.addAttribute("pageName", "Job Sides Page Coming Soon");
		logger.info("Method : viewProduct ends");
		return "recruitment/view-action";
	...
	@GetMapping("budget-plan")
	public String budgetplan(Model model, HttpSession session) {

		logger.info("Method : viewProduct starts");
		model.addAttribute("pageName", "Budget Plan Page Coming Soon");
		logger.info("Method : viewProduct ends");
		return "recruitment/view-action";
