package nirmalya.aathithya.webmodule.bloodbank.model;
...
public class BloodBankProfileModel {
...
private List<BloodBankProfileDocumentModel> documentList;
//
private String profileImg;
private String docExperience;

public BloodBankProfileModel() {
	super();
...
public List<BloodBankProfileDocumentModel> getDocumentList() {
	return documentList;
}

public void setDocumentList(List<BloodBankProfileDocumentModel> documentList) {
