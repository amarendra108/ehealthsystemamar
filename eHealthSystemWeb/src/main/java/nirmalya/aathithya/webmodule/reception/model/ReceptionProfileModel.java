package nirmalya.aathithya.webmodule.reception.model;
...
public class ReceptionProfileModel {
...
private List<ReceptionDocumentModel> documentList;
//
private String profileImg;
private String docExperience;

public ReceptionProfileModel() {
	super();
...
public List<ReceptionDocumentModel> getDocumentList() {
	return documentList;
}

public void setDocumentList(List<ReceptionDocumentModel> documentList) {
