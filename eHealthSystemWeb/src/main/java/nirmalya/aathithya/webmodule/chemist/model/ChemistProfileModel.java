...
private List<ChemistProfileDocumentModel> documentList;
//
private String profileImg;
private String docExperience;

public ChemistProfileModel() {
	super();
...
public List<ChemistProfileDocumentModel> getDocumentList() {
	return documentList;
}

public void setDocumentList(List<ChemistProfileDocumentModel> documentList) {
